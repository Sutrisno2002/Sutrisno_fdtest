                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="2"
                                        style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-weight: 400; line-height: 25px;">
                                        <p style="margin: 0;">Selamat bergabung menjadi Anggota Relawan Gibran Penerus
                                            Jokowi (GPJ)!</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"
                                        style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-weight: 400; line-height: 25px;">
                                        <p style="margin: 0;">Anda dapat mengunduh KTA Elektronik melalui lampiran yang
                                            terdapat dalam email ini.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"
                                        style="padding-left:30px;padding-right:15px;padding-bottom:30px; font-family: Helvetica, Arial, sans-serif; font-weight: 400; line-height: 25px;">
                                        <p style="margin: 0;">Terima kasih atas partisipasi dan dukungan Anda.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="2"
                                        style="padding-left:30px;padding-right:15px;font-family: Helvetica, Arial, sans-serif; font-weight: 400; line-height: 25px;">
